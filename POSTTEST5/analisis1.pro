...
PREDICATES	
	...
	cetak_orang(nama)					
CLAUSES		
	yang_ulang_tahun_bulan_ini:-				%Data akan akan diambil yang ulang tahun bulan saat ini
	write("**** Daftar Orang Yang Ulang Tahun Bulan Ini ****"),nl, 
	write(" Nama Pertama\t\t Nama Kedua\n"),		
	write("******************************************************"),nl,
	date(_, Bulan_ini, _), %mengambil data bulan dari sistem komputer
	daftar_telepon(Orang, _, Tanggal),				
	cek_bulan_ulang_tahun(Bulan_ini, Tanggal),
	cetak_orang(Orang),
	fail.								%pencarian terselesaikan
	yang_ulang_tahun_bulan_ini:-
...
Bul = Bulan1. %data  tanggal lahir dari bulan januari sampai desember
...
Karena mereka pada bulan maret dan bulan di ambil dari sistem komputer jadi bulan saat ini akan menampilkan data dari yang ulang tahun di bulan maret proses pencarian akan di di telusuri melalui 
fakta - fakta dari klausa yang ada.*/